...
import com.bekurir.biz.activity.OrdervalidasiActivity;
import com.bekurir.biz.activity.SplashActivity;
import com.bekurir.biz.constants.BaseApp;
import com.bekurir.biz.models.User;
import com.bekurir.biz.models.fcm.DriverResponse;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    private void parseAndSendMessage(Map<String, String> mapResponse) {
        if (Objects.requireNonNull(mapResponse.get("type")).equals("1")) {
            ...
            response.setIddriver(mapResponse.get("driver_id"));
    ...
    private void otherHandler(RemoteMessage remoteMessage){
        ...
        {
            String channelId = "ornidsmerchant";
            NotificationChannel channel = new NotificationChannel(
                    channelId,
                    "Channel ornidsmerchant",
    ...
    private void notificationOrderBuilderCancel(RemoteMessage remoteMessage) {
        ...
        intent1.putExtra("customer_id",remoteMessage.getData().get("customer_id"));
    ...
    private void notificationOrderBuilderStart(RemoteMessage remoteMessage) {
        ...
        intent1.putExtra("id", remoteMessage.getData().get("transaction_id"));
        intent1.putExtra("iddriver",remoteMessage.getData().get("driver_id"));
        intent1.putExtra("idpelanggan",remoteMessage.getData().get("customer_id"));
        intent1.putExtra("response",remoteMessage.getData().get("response"));
        PendingIntent pIntent1 = PendingIntent.getActivity(this, (int) System.currentTimeMillis(), intent1, 0);
