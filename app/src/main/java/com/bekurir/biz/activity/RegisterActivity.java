...
import com.bekurir.biz.models.ServiceModel;
import com.bekurir.biz.models.CategoryModel;
import com.bekurir.biz.utils.Log;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(phone.getText().toString())) {
                    ...
                    notif("location tidak boleh kosong!");
...
//            Send_Number_tofirebase(phoneNumber);
        ...
        verificationCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    notif2("terlalu banyak permintaan, silahkan coba dengan no telp lain!");
                    notif("terlalu banyak permintaan, silahkan coba dengan no telp lain!");
                }
            }
    ...
    public void verifyCode(View view) {
        ...
        if (!code.equals("")) {
            ...
            notif2("Masukkan verifikasi kode kamu!");
        }
        ...
        service.register(request).enqueue(new Callback<RegisterResponseJson>() {
            ...
            public void onResponse(Call<RegisterResponseJson> call, Response<RegisterResponseJson> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    notif("ada kesalahan server silahkan ulangi lagi!");
                }
            }
